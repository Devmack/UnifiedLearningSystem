...
namespace UnifiedLearningSystem.Application.Mappers
{
    ...
    {
        public LearningTask ConvertFrom(LearningTaskReadDTO readDTO) => LearningTaskFactory.Build(readDTO._taskTitle, readDTO._taskDescription, readDTO.codeStarter);

        public LearningTaskReadDTO ConvertFrom(LearningTask readDTO)
        {
            return new(readDTO.AggregateID, readDTO.TaskTitle, readDTO.TaskDescription, readDTO.TaskCodeStarter);
        }
    }
}
