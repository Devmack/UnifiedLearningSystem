...
namespace UnifiedLearningSystem.Infrastructure.Migrations
{
    ...
    [Migration("20220815081403_imageHeader")]
            ...
            modelBuilder.Entity("UnifiedLearningSystem.Domain.Entities.LearningTask", b =>
                {
                    ...
                    b.OwnsOne("UnifiedLearningSystem.Domain.ValueObjects.Task.TaskCodeStarter", "TaskCodeStarter", b1 =>
                        {
                    ...
                    b.OwnsOne("UnifiedLearningSystem.Domain.ValueObjects.Task.TaskImageHeader", "TaskImageHeader", b1 =>
                        {
                            b1.Property<Guid>("LearningTaskAggregateID")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.Navigation("TaskCodeStarter")
                        .IsRequired();

                    b.Navigation("TaskDescription")
                        .IsRequired();

                    b.Navigation("TaskImageHeader")
                        .IsRequired();
